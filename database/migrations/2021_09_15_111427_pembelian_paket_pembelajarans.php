...
class PembelianPaketPembelajarans extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('pembelian_paket_pembelajaran', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('pembelian_paket_pembelajaran');
    }
}
