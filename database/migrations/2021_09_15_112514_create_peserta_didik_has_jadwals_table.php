...
class CreatePesertaDidikHasJadwalsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('peserta_didik_has_jadwal', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('peserta_didik_has_jadwal');
    }
}
