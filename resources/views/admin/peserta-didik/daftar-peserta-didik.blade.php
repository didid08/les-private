...
@section('main')
    <main class="h-full overflow-y-auto">
        <div class="container px-6 mx-auto grid">
            ...
            <div class="w-full overflow-hidden rounded-lg shadow-xs mb-4" id="daftar-peserta-didik">
                <div class="w-full overflow-x-auto">
                    ...
                    <table class="w-full whitespace-no-wrap" id="daftar-peserta-didik-table">
                        <thead>
                            <tr
                                ...
                                <tr class="text-gray-700 dark:text-gray-400">
                                    <td class="px-4 py-3 nama">
                                        <div class="flex items-center text-sm">
                                            ...
                                            <div>
                                                <p class="font-semibold">{{ $pesertaDidik->nama }}</p>
                                                <p class="text-xs text-gray-600 dark:text-gray-400">
                                                    <a href="mailto:{{ $pesertaDidik->email }}">{{ $pesertaDidik->email }}</a>
                                                </p>
                                            </div>
                                        </div>
                                    </td>
